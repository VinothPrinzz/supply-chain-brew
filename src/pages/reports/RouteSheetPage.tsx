...
import { fetchBatches, fetchRoutes, fetchCustomers, fetchProducts, fetchIndents, fetchContractors } from "@/services/api";
...
const RouteSheetPage = () => {
  ...
  const generatePages = () => routes.map(route => {
    ...
    return (
      <div key={route.id}>
        <div className="text-center mb-3"><h2 className="text-sm font-bold uppercase">Haveri Milk Union — Route Sheet</h2></div>
